...
'''
CREDIT: 
https://gist.github.com/StuartGordonReid/90c8301f9403707a22ff
'''
...
class Similarity:
    ...
    def fractional_distance(self, p_vec, q_vec, fraction=2.0):
        ...
        if memoize:
            ...
            if x is None:
                diff = abs(p_vec - q_vec)  # Thomas: incl. abs() -- Why? --> function returns complex numbers if the difference is negative
